...
global reasonsingle "SNHR61 SNHR6D SNHR70 SNHR7H SNHR7Q  SNHR7Z SNHR80 SNHR8A SNHR8I NGHR61 NGHR71 NGHR7A MZHR7A GNHR81 KEHR81 MDHR80 MLHR81 NGHR81"
	...
	local row=4
		...
		** URBAN RURAL ***
		...
		foreach x of local urblvl {
			estpost svy: tab reasonnotused if hv025==`x', per
			mat mat1=e(b)
			mat mat4=e(obs)
		local row=4 // set the starting row (back again after loop)
			forvalues i=1(1)8 { // create scalars looping through the matrix results
		...
		estpost svy: tab urbrur netused, row per
		mat mat1=e(b)
		scalar na=round(mat1[1,4],0.1) // yes used; urban
		scalar nb=round(mat1[1,5],0.1) // yes used; rural
		
		putexcel K2=(na) L2=(nb) 
...
gen filename="SNHR8I"
	...
	* not needed for 61
	...
	save "/Users/hannahkoenker/Dropbox/A DHS MIS Datasets/Analysis/Reasons/output/SNHR8I_netfile_reasons.dta", replace
	...
	* keep also sh135c_, 'reasons nobody slept in this net'
	...
	replace reasonnotused=55 if netused==1 
	label copy SH130_25 reasonnotused 
	label define reasonnotused 55 "net was used", modify
	label values reasonnotused reasonnotused 
	replace reasonnotused=. if netused==.
	tab reasonnotused, m
	...
	* drop reshaped obs that aren't needed - we just want the rows that are about nets
	...
	putexcel set "/Users/hannahkoenker/Dropbox/A DHS MIS Datasets/Analysis/Reasons/output/Reasons for not using nets.xlsx", sheet("Senegal2021") modify
	putexcel A1=("Country") B1=("Year") C1=("Reason net not used") D1=("overall") E1=("95% CI") F1=("N") H1=("among hh with not enough") I1=("among hh with just right") J1=("among hh with too many") K1="urban" L1="rural", txtwrap
	...
	** investigate itnsupply for nets that have 'other' response
		merge m:1 hv001 hv002 using "/Users/hannahkoenker/Dropbox/A DHS MIS Datasets/AllHRPR/SNHR8I_nitn.dta"
		gen netsupply=.
		replace netsupply=1 if netpers>0 & netpers<0.5
	...
	** investigate itnsupply for nets that have 'other' response
		...
		** URBAN RURAL ***
		...
		foreach x of local urblvl {
			...
			mat mat4=e(obs)
		local row=4 // set the starting row (back again after loop)
			forvalues i=1(1)18 { // create scalars looping through the matrix results
				scalar r`i'=round(mat1[1,`i'],0.1)
...
*/	
	...
	** URBAN RURAL ***
		...
		estpost svy: tab reasonnotused hv025, col per	
		
		
		local row=4
		
			forvalues i=1(1)36 { // create scalars looping through the matrix results
				scalar r`i'=round(e(b)[1,`i'],0.1)
			}
			foreach m of numlist 1/18 {
				putexcel K`row'=(r`m') // put the result into tokenized column (`1') and looping row
				local row=`row'+1 
			}
				
			local row=4
				
			foreach m of numlist 19/36 {
				putexcel L`row'=(r`m') // put the result into tokenized column (`1') and looping row
				local row=`row'+1 
			}
...
*/	
		...
		** URBAN RURAL ***
		...
		foreach x of local urblvl {
			...
			mat mat4=e(obs)
		local row=4 // set the starting row (back again after loop)
			forvalues i=1(1)13 { // create scalars looping through the matrix results
				scalar r`i'=round(mat1[1,`i'],0.1)
...
***********
* Mali 2021- MLHR81 sh130_01-15
***********
	
	use MLHR81FL.dta, clear 
	...
	* Run the do file that names the datasets, to generate country name ("dataset") and survey_type info
	...
	foreach var in hml3_ hml4_ hml7_ hml10_ hml11_ hml21_ sh130_ {
		foreach i of numlist 1/9 {
		rename `var'0`i' `var'`i'
	}
	}
		
	save "/Users/hannahkoenker/Dropbox/A DHS MIS Datasets/Analysis/Reasons/output/MLHR81_netfile_reasons.dta", replace
	...
	* keep also sh37_, 'reasons nobody slept in this net'
	...
	clonevar reasonnotused=sh130_
	replace reasonnotused=55 if netused==1 
	label copy SH130_15 reasonnotused 
	label define reasonnotused 55 "net was used", modify
	label values reasonnotused reasonnotused 
	replace reasonnotused=. if netused==.
	tab reasonnotused, m
	...
	* drop reshaped obs that aren't needed - we just want the rows that are about nets
	...
	putexcel set "/Users/hannahkoenker/Dropbox/A DHS MIS Datasets/Analysis/Reasons/output/Reasons for not using nets.xlsx", sheet("Mali2021") modify
	putexcel A1=("Country") B1=("Year") C1=("Reason net not used") D1=("overall") E1=("95% CI") F1=("N") H1=("among hh with not enough") I1=("among hh with just right") J1=("among hh with too many") K1="urban" L1="rural", txtwrap
	...
	* next, run the single question with multiple non-sequential answers 
	...
	local row=4
		...
		* number loop below = # of responses in label, including other, dk, netused, and +1 for Total.
		...
		putexcel  C4="Too hot" C5="Don't like shape/color/size"  C6=("Don't like smell") C7=("Unable to hang") C8=("Slept outside") C9=("Usual user not here") C10=("No mosquitoes/no malaria") C11=("Extra/saving for later") C12="Net faulty/torn/unusable" C13="think no need to use" C14=("Net used") C15=("Other")  C16=("Total")
	...
	** investigate itnsupply for nets that have 'other' response
		merge m:1 hv001 hv002 using "/Users/hannahkoenker/Dropbox/A DHS MIS Datasets/AllHRPR/MLHR81_nitn.dta"
		gen netsupply=.
		replace netsupply=1 if netpers>0 & netpers<0.5
...
*/	
			...
			local row=4 
		* check total number of cells in the matrix and input below: Mali 2021. there are no shape/color/size reasons for netsupply crosstab.
			foreach i of numlist 1/36 {
				scalar r`i'=round(mat1[1,`i'],0.1)
			}
		
				putexcel H4=r1 H5=0 H6=r2 H7=r3 H8=r4 H9=r5 H10=r6 H11=r7 H12=r8 H13=r9 H14=r10 H15=r11 H16=r12   ///
						 I4=r13 I5=0 I6=r14 I7=r15 I8=r16 I9=r17 I10=r18 I11=r19 I12=r20 I13=r21 I14=r22 I15=r23 I16=r24   ///
						 J4=r25 J5=0 J6=r26 J7=r27 J8=r28 J9=r29 J10=r30 J11=r31 J12=r32 J13=r33 J14=r34 J15=r35 J16=r36 
...
***********
* Nigeria 2021- NGHR81 sh130_01-15
***********
	...
	* Run the do file that names the datasets, to generate country name ("dataset") and survey_type info
	...
	save "/Users/hannahkoenker/Dropbox/A DHS MIS Datasets/Analysis/Reasons/output/NGHR81_netfile_reasons.dta", replace
	...
	* drop reshaped obs that aren't needed - we just want the rows that are about nets
	...
	putexcel set "/Users/hannahkoenker/Dropbox/A DHS MIS Datasets/Analysis/Reasons/output/Reasons for not using nets.xlsx", sheet("Nigeria2021") modify
	putexcel A1=("Country") B1=("Year") C1=("Reason net not used") D1=("overall") E1=("95% CI") F1=("N") H1=("among hh with not enough") I1=("among hh with just right") J1=("among hh with too many") K1="urban" L1="rural", txtwrap
	...
	* next, run the single question with multiple non-sequential answers 
	...
	local row=4
		...
		* number loop below = # of responses in label, including other, dk, netused, and +1 for Total.
		...
		putexcel  C4="No mosquitoes" C5="No malaria" C6="Too hot" C7="Don't like smell" C8="Feel closed in" C9="Net too old/torn" C10=("Net too dirty") C11="Net not available (washing)" C12=("Usual user not here") C13=("Net not needed") C14="Bedbugs" C15=("Net used") C16=("Other") C17="don't know" C18=("Total")
	...
	** investigate itnsupply for nets that have 'other' response
		merge m:1 hv001 hv002 using "/Users/hannahkoenker/Dropbox/A DHS MIS Datasets/AllHRPR/NGHR81_nitn.dta"
		gen netsupply=.
		replace netsupply=1 if netpers>0 & netpers<0.5
...
*/	
		...
		* check total number of cells in the matrix and input below: Mali 2021. there are no shape/color/size reasons for netsupply crosstab.
			foreach i of numlist 1/45 {
				...
				putexcel H4=r1 H5=r2 H6=r3 H7=r4 H8=r5 H9=r6 H10=r7 H11=r8 H12=r9 H13=r10 H14=r11 H15=r12 H16=r13 H17=r14 H18=r15 ///
						 I4=r16 I5=r17 I6=r18 I7=r19 I8=r20 I9=r21 I10=r22 I11=r23 I12=r24 I13=r25 I14=r26 I15=r27 I16=r28 I17=r29 I18=r30   ///
						 J4=r31 J5=r32 J6=r33 J7=r34 J8=r35 J9=r36 J10=r37 J11=r38 J12=r39 J13=r40 J14=r41 J15=r42 J16=r43 J17=r44 J18=r45 
	...
	** URBAN RURAL ***
		...
		local row=4 // set the starting row (back again after loop)
			forvalues i=1(1)15 { // create scalars looping through the matrix results
				scalar r`i'=round(mat1[1,`i'],0.1)
...
*** Check consistency of reasons over rural/urban for each survey:
foreach c in $reasonsingle {
	use "/Users/hannahkoenker/Dropbox/A DHS MIS Datasets/Analysis/Reasons/output/`c'_netfile_reasons.dta", clear
	di "`c'"
	tab  reasonnotused hv025
}

// it's just Mozambique; no itching in rural
